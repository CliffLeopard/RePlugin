...
public class SampleApplication extends RePluginApplication {
    ...
    private class HostEventCallbacks extends RePluginEventCallbacks {
        ...
        public void onInstallPluginSucceed(PluginInfo info) {
            Log.e(TAG, "onInstallPluginSucceed: path=" + info.getName() + "; packageName=" + info.getPackageName());
            super.onInstallPluginSucceed(info);
        }

        @Override
        public void onPrepareAllocPitActivity(Intent intent) {
            Log.e(TAG, "onPrepareAllocPitActivity:" + intent.toString());
        ...
        public void onPrepareStartPitActivity(Context context, Intent intent, Intent pittedIntent) {
            Log.e(TAG, "onPrepareStartPitActivity: intent:" + intent.toString() + "  pittedIntent:" + pittedIntent.toString());
        ...
        public void onActivityDestroyed(Activity activity) {
            Log.e(TAG, "onActivityDestroyed:" + activity == null ? "" : activity.getClass().getSimpleName());
