...
public class PluginProviderClient {
    ...
    public static InputStream openInputStream(Context c, Uri uri) throws FileNotFoundException {
        if (c == null) {
            return null;
        }
    ...
    public static OutputStream openOutputStream(Context c, Uri uri) throws FileNotFoundException {
        if (c == null) {
            return null;
        }
    ...
    public static OutputStream openOutputStream(Context c, Uri uri, String mode) throws FileNotFoundException {
        if (c == null) {
            return null;
        }
    ...
    public static ParcelFileDescriptor openFileDescriptor(Context c, Uri uri, String mode) throws FileNotFoundException {
        if (c == null) {
            return null;
        }
        ...
        try {
            return (ParcelFileDescriptor) ProxyRePluginProviderClientVar.openFileDescriptor.call(null, c, uri, mode);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static ParcelFileDescriptor openFileDescriptor(Context c, Uri uri, String mode, CancellationSignal cancellationSignal) throws FileNotFoundException {
        if (c == null) {
            return null;
        }
        ...
        try {
            return (ParcelFileDescriptor) ProxyRePluginProviderClientVar.openFileDescriptor2.call(null, c, uri, mode, cancellationSignal);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static void registerContentObserver(Context c, Uri uri, boolean notifyForDescendants, ContentObserver observer) {
        ...
        if (!RePluginFramework.mHostInitialized) {
            c.getContentResolver().registerContentObserver(uri, notifyForDescendants, observer);
            return;
        }
    ...
    public static ContentProviderClient acquireContentProviderClient(Context c, String name) {
        ...
        try {
            return (ContentProviderClient) ProxyRePluginProviderClientVar.acquireContentProviderClient.call(null, c, name);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static void notifyChange(Context c, Uri uri, ContentObserver observer, boolean syncToNetwork) {
        if (c == null) {
            return;
        }

        if (!RePluginFramework.mHostInitialized) {
            c.getContentResolver().notifyChange(uri, observer, syncToNetwork);
            return;
        }

        try {
            ProxyRePluginProviderClientVar.notifyChange2.call(null, c, uri, observer, syncToNetwork);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static Uri toCalledUri(Context c, Uri uri) {
        ...
        try {
            return (Uri) ProxyRePluginProviderClientVar.toCalledUri.call(null, c, uri);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static Uri toCalledUri(Context c, String plugin, Uri uri, int process) {
        ...
        try {
            return (Uri) ProxyRePluginProviderClientVar.toCalledUri2.call(null, c, plugin, uri, process);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
    ...
    public static String getType(Context c, Uri url) {
        if (c == null) {
            return null;
        }
        if (!RePluginFramework.mHostInitialized) {
            return c.getContentResolver().getType(url);
        }
        try {
            return (String) ProxyRePluginProviderClientVar.getType.call(null, c, url);
        } catch (Exception e) {
            if (LogDebug.LOG) {
                e.printStackTrace();
            }
