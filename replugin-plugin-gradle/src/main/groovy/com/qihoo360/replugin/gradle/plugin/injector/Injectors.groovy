...
import com.qihoo360.replugin.gradle.plugin.injector.zhushou.ConstantValueInjector
/**
...
public enum Injectors {
    ...
    CONSTANT_VALUE_INJECTOR('ConstantValueInjector', new ConstantValueInjector(), '替换 Constant.PLUGIN_NAME 调用')
